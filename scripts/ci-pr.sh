...
python3 -c 'import ast, pathlib; [ast.parse(pathlib.Path(path).read_text()) for path in ("oracle/build_m1_corpus.py", "oracle/build_m1_synthetic_fixtures.py", "oracle/mutate_m1_synthetic_fixture.py", "oracle/oracle_identity.py", "oracle/m1_bench_worker.py", "oracle/m1_server_smoke.py")]'
