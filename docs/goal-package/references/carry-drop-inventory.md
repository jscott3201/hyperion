...
| Real-workload corpus + protected-aggregate holdouts + low_n policy | **CARRY method / REPLACE contents** | Helios | The discipline that kept MTP honest. Contents become target-workload-shaped prompts, frozen with SHA manifests. |
